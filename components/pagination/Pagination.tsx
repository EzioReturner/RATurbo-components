...
const Pagination: React.FC<PaginationProps> = props => {
  ...
  const bindEvent = () => {
    ...
    const bl = _document.getElementById(`${prefixCls}-button-left`);

    const br = _document.getElementById(`${prefixCls}-button-right`);
  ...
  const LeftButton = (
    ...
    >
      <ChevronLeft className={`${prefixCls}-button-icon`} />
  ...
  const RightButton = (
    ...
    >
      ...
      <ChevronRight className={`${prefixCls}-button-icon`} />
    </div>
  );
